...
class History extends React.PureComponent {
  ...
  render() {
    const { contractByIdUser } = this.props;
    const { numberPages, limitHistory, offset, page } = contractByIdUser;
    ...
    console.log('1111111111111111',contractByIdUser);
    // let i = 0;
            ...
            <thead>
              <tr>
                ...
                <th className="text-center">
                  {decoded.categoryUser === 1 ? "Người gửi" : "Người nhận"}
                </th>
              ...
              {contractByIdUser.hasOwnProperty("limitHistory")
                ? limitHistory.map(item => (
                    <tr
                      ...
                      onClick={this.onClickRow.bind(this, item.idContract)}
                    >
