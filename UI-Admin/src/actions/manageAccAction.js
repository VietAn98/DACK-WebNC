...
export const getListStudent = () => (dispatch) => fetch(API.GET_STUDENtS, {
      method: 'GET',
      headers: {
...
export const getDetailUser = (id) => (dispatch) => fetch(API.GET_DETAIL_USER + id, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'
      }
...
export const getAddressByUser = (id) => (dispatch) => fetch(API.GET_ADDRESS_USER + id, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'
      }
...
export const getDistrictByUser = (id) => (dispatch) => fetch(API.GET_DISTRICT_USER + id, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'
      }
...
export const getListTeacher = () => (dispatch) => fetch(API.GET_TEACHERS, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'
      }
