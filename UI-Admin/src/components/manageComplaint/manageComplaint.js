...
import { Table, Button, Pagination, Spinner, Form, Col } from "react-bootstrap";
...
class Complaint extends React.PureComponent {
  ...
  render() {
    ...
    const { numberPages, limitComplaint, offset, page } = listComplaint;
    ...
    return (
      <div style={{ padding: "10px" }}>
        ...
        {listComplaint.hasOwnProperty("limitComplaint") ? null : (<div style={{ textAlign: "center" }}>
